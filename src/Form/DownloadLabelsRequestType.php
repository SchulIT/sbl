...
class DownloadLabelsRequestType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void {
        $builder
            ...
            ->add('setPrintedAtDate', CheckboxType::class, [
                'label' => 'labels.download.set_printed_at.label',
                'help' => 'labels.download.set_printed_at.help',
                'required' => false,
            ])
            ->add('skipAlreadyPrinted', CheckboxType::class, [
                'label' => 'labels.download.skip_already_printed.label',
                'help' => 'labels.download.skip_already_printed.help',
                'required' => false
            ]);
    }
}